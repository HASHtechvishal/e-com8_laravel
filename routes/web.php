...
//shipping charges
            Route::get('shipping-charges','ShippingController@ShippingController');
            Route::match(['get','post'],'edit_shipping_rate/{id?}','ShippingController@editShippingRate');
            Route::match(['get','post'],'edit_advShipping_rate/{id?}','ShippingController@editAdvShippingRate');                                                                      
}); 
...
Route::namespace('front')->group(function(){
    ...
    //paypal ipn
        Route::/*post*//*any used for developer it pick any function*/any('/paypal/ipn','PaypalController@ipn');
    ...
    //payumoney success
        Route::get('/payumoney/success','PayumoneyController@successPage');

    //payumoney fail
        Route::get('/payumoney/fail','PayumoneyController@failPage');
