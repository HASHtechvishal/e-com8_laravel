    ...
    //if coupon is error then coupon discount will zero then we add plus product it will again show privous discount number will come again                       
        ...
        public function checkout(Request $req){
            ...
            if (count($userCartItems)==0) {
                $msg = "shopping cart id empty! please add product to checkout";
            ...
            $product_weight = $item['product']['product_weight'];
                ...
                $AttrPrice = Product::getDiscountedAttrPrice($item['product_id'],$item['size']);
                $total_price = $total_price + ($AttrPrice['discounted_price'] * $item['quantity']);
            } 
            ...
            if ($req->isMethod('post')) {
             ...
             /*   $message = "dear customer your order".$order_id."had been successfully placed with e-com website. we will intimate you once your order is shipped";
                ...
                Mail::send('emails.order',$messageData,function($message) use($email){
                    ...
                    //payumoney redirect user to payumoney page after placing order
            ...
            return view('front e-com.products.checkout')->with(compact('userCartItems','deliveryAddress','total_price'));
        }
