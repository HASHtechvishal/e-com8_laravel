...
@if(Session::get('page')=="categories" || Session::get('page')=="sections" || Session::get('page')=="products" || Session::get('page')=="brands" || Session::get('page')=="banners" || Session::get('page')=="coupon" || Session::get('page')=="shipping-charges");
 <?php $active = "active"; ?>
 @else
 <?php $active = ""; ?>
 @endif                      
...
@if(Session::get('page')=="orders")
 ...
 @endif                           
              <li class="nav-item">
                <a href="/admin/shipping-charges" class="nav-link {{$active}}">
                  <i class="far fa-circle nav-icon"></i>
